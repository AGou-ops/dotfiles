        ...
        config = function()
            require'treesitter-context'.setup {
                ...
                patterns = { -- Match patterns for TS nodes. These get wrapped to match at word boundaries.
                    ...
                    vhdl = {
                        'process_statement', 'architecture_body',
                        'entity_declaration'
                    },
                    markdown = {'section'},
                    elixir = {
        ...
        config = function()
            require("nvim-treesitter.configs").setup({
                ensure_installed = {
                    ...
                    "cpp", "css", "diff", "fish", "gitignore", "go", "graphql",
                    "help", "html", "http", "java", "javascript", "jsdoc",
                    "jsonc", "latex", "lua", "markdown", "markdown_inline",
                    "meson", "ninja", "nix", "norg", "org", "php", "python",
                    "query", "regex", "rust", "scss", "sql", "svelte", "teal",
                    "toml", "tsx", "typescript", "vhs", "vim", "vue", "wgsl",
                    "yaml", -- "wgsl",
                    "json"
                    -- "markdown",
                },
