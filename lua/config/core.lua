...
local defaults = {
  ...
  defaults = {
    autocmds = true, -- config.autocmds_core
    keymaps = true, -- config.keymaps_core
    -- config.options_core can't be configured here since that's loaded before lazyvim setup
    -- if you want to disable loading options, add `package.loaded["config.options_core"] = true` to the top of your init.lua
  },
  news = {
...
function M.setup(opts)
  ...
  vim.api.nvim_create_autocmd("User", {
    ...
    callback = function()
      ...
      -- Disabled check as structure has changed
