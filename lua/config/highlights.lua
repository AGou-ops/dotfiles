...
function M.apply()
  ...
  -- Noice cmdline/popup highlights
  hi("NoiceCmdlinePopup", { link = "NormalFloat" })
  hi("NoiceCmdlinePopupBorder", { link = "FloatBorder" })
  hi("NoiceCmdlinePopupBorderSearch", { link = "FloatBorder" })
  hi("NoiceCmdlinePopupTitle", { link = "FloatBorder" })
  hi("NoicePopupmenu", { link = "NormalFloat" })
  hi("NoicePopupmenuBorder", { link = "FloatBorder" })
...
function M.setup()
  local group = vim.api.nvim_create_augroup("UserCustomHighlights", { clear = true })
